...
export default function Introduction() {
  return (
    <div className='bg-[#131424]/60 w-full z-10'>
      <div className='w-full h-full bg-gradient-to-r from-violet-500/20 to-fuchsia-500/30'>
        <div className='container grid items-center h-full px-5 mx-auto md:grid-cols-2 text-left'>
          <motion.div
